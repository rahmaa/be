...
function taq_admin_register() {
	...
	wp_register_script( 'taqyeem-admin-eye',  plugins_url('admin/js/eye.js' , __FILE__), array( 'jquery' ) , false , false );  
	wp_register_script( 'taqyeem-admin-utils',  plugins_url('admin/js/utils.js' , __FILE__) , array( 'jquery' ) , false , false );  
	wp_register_script( 'taqyeem-admin-layout',  plugins_url('admin/js/layout.js' , __FILE__) , array( 'jquery' ) , false , false );  
	...
	if ( isset( $_GET['page'] ) && $_GET['page'] == 'taqyeem' ) {
		...
		wp_enqueue_script( 'taqyeem-admin-eye' );  
		wp_enqueue_script( 'taqyeem-admin-utils' );  
		wp_enqueue_script( 'taqyeem-admin-layout' );
