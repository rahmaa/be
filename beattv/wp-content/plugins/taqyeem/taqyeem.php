...
function taqyeem_get_score( $post_id = false , $size = 'small' ){
	...
	?>
	<span title="<?php echo $short_summary ?>" class="post-single-rate post-<?php echo $rate_size; ?>-rate"><div class="review-score-small-cric"><?php echo  round(($total_score/10),1) ?></div></span>
	<?php 
	}
}
